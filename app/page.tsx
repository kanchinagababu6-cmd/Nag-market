    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-2xl backdrop-blur-sm">
        <div className="text-center space-y-1 mb-6">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Nag Supermarket</h1>
          <p className="text-xs text-slate-400">Fresh Groceries & Daily Essentials Portal</p>
        </div>
        ...
        <div className="mb-6 p-3 bg-slate-950 border border-slate-800 rounded-2xl flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-slate-400">Browse store items & order online</p>
          </div>
          <Link
            href="/shop"
      ...
      <p className="mt-6 text-[11px] text-slate-600">
        © {new Date().getFullYear()} Nag Supermarket. All rights reserved.
      </p>
    </div>
  );
}
